...
# $Header: /var/cvsroot/gentoo-x86/games-simulation/openttd/openttd-1.0.5.ebuild,v 1.6 2010/11/28 12:19:11 hwoarang Exp $
...
SRC_URI="http://cz.binaries.openttd.org/openttd/binaries/releases/${PV}/${P}-source.tar.gz"
