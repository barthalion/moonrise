...
# $Header: /var/cvsroot/gentoo-x86/media-libs/libsdl/libsdl-1.2.14-r6.ebuild,v 1.1 2011/03/08 22:09:48 mr_bones_ Exp $
...
IUSE="oss alsa nas X dga xv xinerama fbcon directfb ggi svga tslib aalib opengl libcaca +audio +video +joystick custom-cflags pulseaudio ps3 static-libs esd"
...
src_configure() {
	...
	econf \
		...
		--enable-file \
		--enable-cpuinfo \
		$(use_enable alsa alsa-shared) \
		$(use_enable esd esd-shared) \
		$(use_enable pulseaudio pulseaudio-shared) \
		--disable-arts-shared \
		$(use_enable nas nas-shared) \
